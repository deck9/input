...
-   **Rich Text Formatting**: Support for markdown to create structured content
-   **Visual Elements**: Include images, links, and formatted text
-   **Button Additions**: Can be combined with button interactions for navigation
-   **Information Display**: Perfect for explanatory content that doesn't require input

## Example Uses:

-   **Welcome Screens**: Introduction to your form or survey
-   **Instructions**: Guidelines on how to complete sections of your form
-   **Disclaimers**: Legal information or important notices
-   **Section Breaks**: Visual separation between different parts of your form
-   **Explanations**: Additional context before complex questions
-   **Thank You Messages**: Acknowledgments for participation
...
-   To explain complex topics before related questions
-   When you want to insert visual breaks between sections
